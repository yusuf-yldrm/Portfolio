...
const ContainerLatestShots: NextPage<ContainerLatestShotsType> = ({
  ...
  return (
    <a
      className="rounded-10xs bg-gray-300 flex flex-row py-[25px] pr-[49px] pl-12 items-start justify-start text-center text-base text-darkgray font-outfit border-[1px] border-solid border-gray-200"
