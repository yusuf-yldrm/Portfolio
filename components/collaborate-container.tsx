  ...
  return (
    <div className="flex flex-col p-2.5 items-center justify-start gap-[45px] text-center text-13xl text-gray-100 font-outfit">
      <div className="w-full shrink-0 flex flex-col py-5 box-border items-center justify-center gap-[2px]">
        <div className="relative leading-[42px]  flex items-center justify-center h-10 shrink-0">
          Collaborate with brands and agencies to create impactful results.
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start justify-start gap-[45px] text-left text-lg">
        <KnowLedgeContainer
          icon="mobile"
