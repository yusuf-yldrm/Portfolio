  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-white">
      <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto">
        ...
        <p className="text-white mb-8">Last updated: OCT 14, 2024</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Countdowns, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Yusuf Yıldırım.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Yusuf Yıldırım, accessible from{" "}
              <a
                href="https://yusufyildirim.dev"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://yusufyildirim.dev
              </a>
            </p>
          </li>
          <li>
